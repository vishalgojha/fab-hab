...
export default function Challenges() {
  ...
  const handleJoinChallenge = async (challenge, teamName = null) => {
    try {
  ...
  const myChallenges = filteredChallenges.filter(c => 
    myParticipations.some(p => p.challenge_id === c.id)
  );
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <CreateChallengeDialog
        ...
        onCreated={() => queryClient.invalidateQueries(['challenges'])}
      />
      ...
      <ChallengeDetailModal
        ...
        onJoin={handleJoinChallenge}
        isParticipant={myParticipations.some(p => p.challenge_id === selectedChallenge?.id)}
      />
