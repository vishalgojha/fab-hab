...
export default function CoachingNotificationCenter({ isOpen, onClose }) {
  ...
  const markAsReadMutation = useMutation({
    mutationFn: (id) => base44.entities.CoachingNotification.update(id, { is_read: true }),
    onSuccess: () => queryClient.invalidateQueries(['coaching-notifications'])
  });

  const markAsActedMutation = useMutation({
    mutationFn: (id) => base44.entities.CoachingNotification.update(id, { is_acted_upon: true }),
    onSuccess: () => queryClient.invalidateQueries(['coaching-notifications'])
  });
